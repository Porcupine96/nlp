...
function toIcon(item) {
  switch (item) {
    case /* One */0 :
        return ReasonReact.element(undefined, undefined, Curry._8(LooksOne$MscharleyBsMaterialUiIcons.Outlined.make, undefined, undefined, undefined, undefined, undefined, undefined, undefined, []));
    case /* Two */1 :
        return ReasonReact.element(undefined, undefined, Curry._8(LooksTwo$MscharleyBsMaterialUiIcons.Outlined.make, undefined, undefined, undefined, undefined, undefined, undefined, undefined, []));
    case /* Three */2 :
        return ReasonReact.element(undefined, undefined, Curry._8(Looks3$MscharleyBsMaterialUiIcons.Outlined.make, undefined, undefined, undefined, undefined, undefined, undefined, undefined, []));
    case /* Four */3 :
        return ReasonReact.element(undefined, undefined, Curry._8(Looks4$MscharleyBsMaterialUiIcons.Outlined.make, undefined, undefined, undefined, undefined, undefined, undefined, undefined, []));
    case /* Five */4 :
        return ReasonReact.element(undefined, undefined, Curry._8(Looks5$MscharleyBsMaterialUiIcons.Outlined.make, undefined, undefined, undefined, undefined, undefined, undefined, undefined, []));
  ...
  return {
          ...
          render: (function (param) {
              ...
              var menu = Belt_Array.map(menuItems, (function (item) {
                      ...
                      var text = ReasonReact.element(undefined, undefined, MaterialUi_Typography.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [message]));
                      return ReasonReact.element(message, undefined, Link$Wordnet.make(item, [ReasonReact.element(message, undefined, MaterialUi_ListItem.make(undefined, true, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [
                                                ReasonReact.element(undefined, undefined, MaterialUi_ListItemIcon.make(undefined, undefined, undefined, [icon])),
                                                ReasonReact.element(undefined, undefined, MaterialUi_ListItemText.make(undefined, undefined, undefined, Caml_option.some(text), undefined, undefined, undefined, undefined, undefined, undefined, []))
                                              ]))]));
                    }));
              return React.createElement("div", {
                          className: layout
                                  ...
                                  header,
                                  ReasonReact.element(undefined, undefined, MaterialUi_Divider.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, [])),
                                  ReasonReact.element(undefined, undefined, MaterialUi_List.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, [menu])),
                                  ReasonReact.element(undefined, undefined, MaterialUi_Divider.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, []))
